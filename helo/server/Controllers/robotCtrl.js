module.exports = {
    ...
    remove: (req, res) => {
        ...
        dbInstance.removeFriend([req.session.user.robot_id, req.body.id, req.query.offset])
            .then(robos => {
                res.status(200).send(robos)
            })
            .catch(err => {
    ...
    newFriend: (req, res) => {
        ...
        dbInstance.newFriend([req.session.user.robot_id, req.body.id, req.query.offset])
            .then(robos => {
                res.status(200).send(robos)
            })
            .catch(err => {
